      ...
      body: Container(
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              const Text(
                'Estado de Actualización en Dispositivos',
                style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                ),
              ),
              _buildCircularButton(1, Icons.system_security_update_good, 'Button 1', Colors.green),
              Text('${_counters[1] ?? 0}', style: TextStyle(color: Colors.green, fontSize: 24)),
              _buildCircularButton(2, Icons.system_security_update, 'Button 2', Colors.orange),
              Text('${_counters[2] ?? 0}', style: TextStyle(color: Colors.orange, fontSize: 24)),
              _buildCircularButton(3, Icons.system_security_update_warning, 'Button 3', Colors.red),
  ...
  return Column(
    children: [
      ...
      FractionallySizedBox(
        widthFactor: 0.6, // Modifica este valor para ajustar el ancho de la barra de progreso
